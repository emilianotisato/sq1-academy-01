window.addEventListener("load", function () {
  ...
  window.updateFrontendStatus = function () {
    ...
    if (hungerStat.textContent >= 0 && hungerStat.textContent < 40) {
      document
        .getElementById("HungerChangeArrow")
        .classList.replace("bg-green-100", "bg-red-100");
      document
      ...
      document
        .getElementById("HungerChangeArrow")
        .classList.replace("bg-red-100", "bg-green-100");
      document
        .getElementById("GreenArrow")
    ...
    if (happinessStat.textContent >= 0 && happinessStat.textContent < 30) {
      document
        .getElementById("HappinessChangeArrow")
        .classList.replace("bg-green-100", "bg-red-100");
      document
        .getElementById("GreenArrow2")
        .classList.replace("text-green-500", "text-red-500");
    } else if (
      happinessStat.textContent > 40 ||
      happinessStat.textContent == 100
    ) {
      document
        .getElementById("HappinessChangeArrow")
        .classList.replace("bg-red-100", "bg-green-100");
    ...
    if (sleepStat.textContent >= 0 && sleepStat.textContent < 20) {
      document
        .getElementById("SleepChangeArrow")
        .classList.replace("bg-red-100", "bg-green-100");
      document
        .getElementById("GreenArrow3")
        .classList.replace("text-red-500", "text-green-500");
    ...
    if (energyStat.textContent >= 0 && energyStat.textContent < 50) {
      document
        .getElementById("EnergyChangeArrow")
        .classList.replace("bg-green-100", "bg-red-100");
      document
        .getElementById("GreenArrow4")
        .classList.replace("text-green-500", "text-red-500");
